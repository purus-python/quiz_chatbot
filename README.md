...
GITHUB : https://github.com/purus-python/quiz_chatbot

Project Structure

STEP 1: Root Directory: app/
        This is the main project folder that contains all necessary files and subdirectories.
________________________________________
STEP 2: quiz/ Folder (Core Functionality)
...
________________________________________
STEP 3: common/ Folder (Shared Utilities)
        ...
        	Response Validation: If a question is unrelated to the document, it returns:
        "Your question is not related to the document. Please ask a relevant question."
        File: config.py
        Purpose:
...
________________________________________
STEP 6: Testing/ Folder (Automated Testing)
        Purpose:
...
STEP 9 : DOCKER FILE  :
	I am not able to push the code to my git repository because of the file size exceeds   more than 25 MB. Because of which I am not able to implement the docker for the same.
	My env project file size : 1.09 GB


STEP 10 : POSTGRYSQL DATABASE CRAETED QUERY 
CREATE TABLE quiz_chat_master (
    id SERIAL PRIMARY KEY,
    quiz_notes JSONB NOT NULL,
